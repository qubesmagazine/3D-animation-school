    ...
    <div className="section" id="courses">
      <div className="text-center">
        ...
        <p className="text-sm text-gray leading-7 max-w-[700px] mx-auto">
          ...
          aliquam. Rem sed asperiores odit porro, sint, illo nobis culpa fugit
          doloremque magnam fuga necessitatibus. Ut vitae beatae eveniet laborum
          molestias alias explicabo, harum officia sit, sint ducimus neque
          minus.
        </p>
      </div>
      <motion.div 
